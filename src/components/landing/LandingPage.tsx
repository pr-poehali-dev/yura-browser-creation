...
export default function LandingPage({ onStartInstallation }: LandingPageProps) {
          ...
          <div className="grid md:grid-cols-3 gap-6 max-w-4xl mx-auto">
            {[
              ...
              <Card key={idx} className="glass border-white/10 p-6 hover:border-[#00D9FF]/50 transition-all cursor-pointer">
                ...
                <Button 
                  onClick={onStartInstallation}
                  className="w-full bg-gradient-to-r from-[#00D9FF] to-[#8B5CF6] hover:opacity-90 border-0"
                >
